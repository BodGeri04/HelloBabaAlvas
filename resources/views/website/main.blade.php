			...
			<div class="rev_slider_wrapper fullwidthbanner-container" id="rev_slider_one_wrapper" data-source="gallery">
				<div class="rev_slider fullwidthabanner" id="rev_slider_one" data-version="5.4.1">
					<ul>
						...
						<li data-transition="slidingoverlayhorizontal" data-description="Slide Description"
							...
							<div class="tp-caption" data-paddingbottom="[0,0,0,0]" data-paddingleft="[0,0,0,0]"
								...
								style="">
								<div class="text">Discover the simple 3 Steps that I Discovered to Hack Productivity.
									<br> It works %100. Wanna transform your life?</div>
							</div>
							...
							<div class="tp-caption  tp-resizeme" data-paddingbottom="[0,0,0,0]"
								...
								data-hoffset="['15','15','15','15']" data-voffset="['190','150','105','100']"
								data-x="['left','left','left','left']" data-y="['middle','middle','middle','middle']"
								data-textalign="['top','top','top','top']"
								data-frames='[{"from":"y:[100%];z:0;rX:0deg;rY:0;rZ:0;sX:1;sY:1;skX:0;skY:0;","mask":"x:0px;y:0px;s:inherit;e:inherit;","speed":1500,"to":"o:1;","delay":1000,"ease":"Power3.easeInOut"},{"delay":"wait","speed":1000,"to":"auto:auto;","mask":"x:0;y:0;s:inherit;e:inherit;","ease":"Power3.easeInOut"}]'
								style="">
								<div class="button-box">
									<a href="services.html" class="theme-btn btn-style-two"><span class="txt">Get Free
											Guide Now</span></a>
								</div>
							</div>
						...
						<li data-transition="slidingoverlayvertical" data-description="Slide Description"
					...
					<div class="content-column col-lg-7 col-md-12 col-sm-12">
						<div class="inner-column">
							<div class="sec-title">
								...
								<div class="text">I dsadasdasdsadsa glad that you have made it here to send a distress
									signal, and inform the Senate that all on board
									dsadasdasdsadsa glad that you have made it here to send a distress signal, and
									inform the Senate that all on boarwere killed. Dantooine. I’m not going to Alderaan.
									I really got to go. But that to me.</div>
							</div>
							<div class="row clearfix">
								<!-- Column -->
				...
				<div class="inner-container">
					<div class="services-carousel owl-carousel owl-theme">
						...
						<div class="service-block">
							<div class="inner-box">
								<div class="image">
									<a href="service-detail.html"><img class="transition-500ms"
											src="assets/images/hattertest.jpg" alt="" /></a>
								</div>
						...
						<div class="service-block translate-top">
							<div class="inner-box">
								<div class="image">
									<a href="service-detail.html"><img class="transition-500ms"
											src="assets/images/resource/service-2.jpg" alt="" /></a>
								</div>
								<div class="lower-content">
						...
						<div class="service-block">
							<div class="inner-box">
								<div class="image">
									<a href="service-detail.html"><img class="transition-500ms"
											src="assets/images/resource/service-3.jpg" alt="" /></a>
								</div>
								<div class="lower-content">
						...
						<div class="service-block translate-top">
							<div class="inner-box">
								<div class="image">
									<a href="service-detail.html"><img class="transition-500ms"
											src="assets/images/resource/service-4.jpg" alt="" /></a>
								</div>
								<div class="lower-content">
						...
						<div class="service-block">
							<div class="inner-box">
								<div class="image">
									<a href="service-detail.html"><img class="transition-500ms"
											src="assets/images/resource/service-5.jpg" alt="" /></a>
								</div>
								<div class="lower-content">
					...
					<div class="title-column col-lg-6 col-md-12 col-sm-12">
						<div class="inner-column">
							<div class="sec-title">
								...
								<div class="text">I am glad that you have made it here to send a distress signal, and
									inform the Senate that all on board were killed. Dantooine. I’m not going to
									Alderaan. I really got to go. But that to me.</div>
							...
							<div class="email-box">
								<form method="post" action="contact.html">
									<div class="form-group">
										...
										<input type="email" name="search-field" value="" placeholder="Email address"
											required>
										<button type="submit" class="theme-btn btn-style-three"><span class="txt">Start
				...
				<div class="row clearfix">
					...
					<div class="process-block col-xl-3 col-lg-6 col-md-6 col-sm-12">
						<div class="inner-box transition-300ms">
							...
							<div class="text">Through plans, you break down a process into small and identify the things
								you accomplish..</div>
						</div>
					</div>
				...
				<div class="row clearfix">
					...
					<div class="course-block col-lg-3 col-md-6 col-sm-12">
						<div class="inner-box wow fadeInLeft" data-wow-delay="150ms" data-wow-duration="1500ms">
							<div class="image">
								<a href="course-detail.html"><img class="transition-500ms"
										src="assets/images/resource/course-2.jpg" alt="" /></a>
							</div>
							<div class="lower-content">
								<h5><a href="course-detail.html">How to success through market segmentation</a></h5>
								<ul class="post-info">
					...
					<div class="course-block col-lg-3 col-md-6 col-sm-12">
						<div class="inner-box wow fadeInLeft" data-wow-delay="300ms" data-wow-duration="1500ms">
							<div class="image">
								<a href="course-detail.html"><img class="transition-500ms"
										src="assets/images/resource/course-3.jpg" alt="" /></a>
							</div>
							<div class="lower-content">
								<h5><a href="course-detail.html">How to success through market segmentation</a></h5>
								<ul class="post-info">
					...
					<div class="course-block col-lg-3 col-md-6 col-sm-12">
						<div class="inner-box wow fadeInLeft" data-wow-delay="450ms" data-wow-duration="1500ms">
							<div class="image">
								<a href="course-detail.html"><img class="transition-500ms"
										src="assets/images/resource/course-4.jpg" alt="" /></a>
							</div>
							<div class="lower-content">
								<h5><a href="course-detail.html">How to success through market segmentation</a></h5>
								<ul class="post-info">
					...
					<div class="client-block col-lg-6 col-md-12 col-sm-12">
						<div class="inner-box">
							<div class="content">
								...
								<div class="text">To take a trivial example, which of us undertakes laborious physical
									exercise yes is this happen here.</div>
							</div>
						</div>
					</div>
									...
									<div class="row clearfix">
										...
										<div class="form-group col-lg-12 col-md-12 col-sm-12">
											<button class="theme-btn btn-style-three" type="submit"
												name="submit-form"><span class="txt">Get a quote</span></button>
										</div>
								...
								<div class="footer-column col-lg-6 col-md-6 col-sm-12">
									<div class="footer-widget info-widget">
										...
										<ul class="contact-info-list">
											<li><span>Head Office</span><a href="#">12/North Hall Tower, <br> NYC,
													UK</a></li>
											<li><span>Sub Office</span><a href="#">34, A/Front Tower, <br> London,
													UK</a></li>
										</ul>
									</div>
								</div>
